...
public class HomeWork5 {
   ...
   */
    ...
    public static class PersonDead extends Exception {
        private PersonDead(String message) {
            super(message);
        }
    }
    ...
    public static class Person {
        ...
        String announce() {
            return "Person " + getName() + " имеет характеристики: " + getHealth() + " здоровья " + getProtection() + " защиты ";
        }
        ...
        void takeDamage(Integer damage) throws Exception {
            ...
            int newHealth = getHealth() - (damage - getProtection());
            if (newHealth <= 0) {
                this.health = 0;
